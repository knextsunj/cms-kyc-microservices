...
import com.github.knextsunj.cms.login.util.LoginUtil;
...
//                .signWith(key)
//                .compact();
        return LoginUtil.buildJwtToken(key,username,EXPIRATIONTIME);
    }
    ...
    public void init() throws IOException {
        ...
        String fileName ="/home/kk/Prog-Prac/Docs/cms-ms/cms.key";
...
//            bytes = inputStream.readAllBytes();
            ...
            logger.info("Does file exist:{}",file.exists());
